...
import eu.recred.fidouaf.clientop.RegistrationRequestProcessor;
...
public class Reg {
	...
	//try {
		// The authenticator generates the keys.
		...
		RegistrationResponse regResponse = p.processRequest(getRegistrationRequest(uafMsg));
