...
import eu.recred.fidouafjava.fido.uaf.msg.TrustedFacetsList;
...
public abstract class OpUtils {
     ...
     */
    public static String getUafRequest(String serverResponse, String facetId, boolean isTrx){
        ...
        try {
            ...
            Version version = (new Gson()).fromJson(String.valueOf(((JSONObject) requestArray.get(0)).getJSONObject("header").getJSONObject("upv")),Version.class);
...
//        return false;
     ...
     * @param facetId a string value composed by app hash. I.e. android:apk-key-hash:Lir5oIjf552K/XN4bTul0VS3Gf
