...
public class Curl {
	...
	public static String getInSeparateThread(String url) {
		Callable<String> getRequest = () -> get(url);
		Future<String> response = ThreadRunner.getInstance().submitCallable(getRequest);
		String res = null;
		try {
			res = response.get();
	...
	public static String postInSeparateThread(String url, String header, String data) {
		Callable<String> postRequest = () -> post(url, header, data);
		Future<String> response = ThreadRunner.getInstance().submitCallable(postRequest);
		String res = null;
		try {
			res = response.get();
		} catch (InterruptedException | ExecutionException e) {
