...
import eu.recred.fidouafjava.fido.uaf.client.RegistrationRequestProcessor;
...
public class Reg {
	...
	try {
		...
		prefs.setSettingsParam("pub", Base64.encodeToString(keyPair.getPublic().getEncoded(), Base64.URL_SAFE));
		prefs.setSettingsParam("priv", Base64.encodeToString(keyPair.getPrivate().getEncoded(), Base64.URL_SAFE));
