 ...
 */
public class RecredFidoAuthPrincipal implements Principal, Serializable {
    private final static String COLON = " : ";

    private final String name;

    public RecredFidoAuthPrincipal(String name) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RecredFidoAuthPrincipal)) {
            return false;
        }
        RecredFidoAuthPrincipal that = (RecredFidoAuthPrincipal) o;
